...
| timesheet | Report Journey hours from HEY tracked time and calendar context as daily decimal hours for manual OpenAir timesheet entry. Use for weekly timesheets, date-range totals, and checking entered hours against HEY. | `~/.agents/skills/timesheet/SKILL.md` |
